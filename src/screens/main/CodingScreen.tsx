          ...
          <>
            <div className="bg-red-500/10 border border-red-500/20 rounded-2xl p-4 flex gap-3 mb-6">
              ...
              <div>
                <p className="text-[10px] uppercase tracking-widest font-bold text-red-500 mb-1">
                  Warning: Advanced Action
                </p>
                <p className="text-xs text-red-500/70 leading-relaxed">
                  Incorrect coding can lead to ECU corruption. Ensure vehicle
                  battery is stable (12.0V+) before writing block data.
                </p>
              </div>
            </div>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div className="flex flex-col text-left">
                  <span className="text-sm font-bold text-white/80">
                    Module Configuration (As-Built)
                  </span>
                  <span className="text-[9px] text-white/40 font-mono tracking-widest uppercase">
                    Hexadecimal Block Editor
                  </span>
                </div>
              </div>
            ...
            <div className="mt-8 text-[10px] font-black uppercase tracking-widest text-white/40 border-b border-white/5 pb-2">
              Easy Config (One-Click)
            </div>
          ...
          <>
            ...
            <div className="grid grid-cols-1 gap-2 mt-4">
              {BIDIRECTIONAL_TESTS.map((test) => (
                ...
                >
                  <div className="flex flex-col text-left">
                    <span className="text-[10px] font-mono text-primary/60 mb-0.5 uppercase tracking-widest">
                      {test.id} // SEC_CMD
                    </span>
            ...
            <p className="text-[8px] text-white/40 font-mono uppercase tracking-[0.2em] px-1 text-center mt-2">
              Caution: Bidirectional tests bypass PCM safety logic.
            </p>
          </>
        )}
      </div>
