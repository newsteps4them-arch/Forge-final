...
import { getAuth, GoogleAuthProvider, signInWithPopup, signInAnonymously, signOut, onAuthStateChanged, signInWithRedirect, signInWithCredential, getRedirectResult } from 'firebase/auth';
