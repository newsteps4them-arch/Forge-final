...
import { ArrowLeft, ToggleLeft, ShieldAlert, Cpu, Zap, Activity, ArrowUp } from 'lucide-react';
    ...
    >
      <div className="flex items-center gap-3 px-6 mb-4">
        ...
        <div className="flex items-center gap-2 text-primary">
          ...
          <h2 className="text-xl font-black uppercase tracking-widest">Coding</h2>
        </div>
      </div>
         ...
         <div className="bg-red-500/10 border border-red-500/20 rounded-2xl p-4 flex gap-3">
            ...
            <div>
               ...
               <p className="text-xs text-red-500/70 leading-relaxed">
                 Incorrect coding can lead to ECU corruption. Ensure vehicle battery is stable (12.0V+) before continuing.
               </p>
            </div>
         </div>
      </div>
      ...
      <div className="flex-1 overflow-y-auto px-6 space-y-4 no-scrollbar">
         {/* Simple Mode (One Click Apps) */}
         <div className="text-[10px] font-black uppercase tracking-widest text-white/40 border-b border-white/5 pb-2">Simple Mods (One-Click)</div>
         ...
         <p className="text-[8px] text-white/40 font-mono uppercase tracking-[0.2em] px-1 text-center mt-2 mb-8">Caution: Bidirectional tests bypass PCM safety logic.</p>

         <div className="mt-8 text-[10px] font-black uppercase tracking-widest text-white/40 border-b border-white/5 pb-2">Advanced Options</div>
         <button 
         ...
         >
            <div className="flex items-center gap-3">
               ...
               <span className="text-sm font-bold text-white/80">Long Coding (Hex Editor)</span>
            </div>
